...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply("🔄 `تتم البرمجه بواسطة سورس الماس......`")
    ...
    if update_avail:
        ...
        return
    await msg.edit(f"تم الترقية بواسطه سورس الماس [Diamond](https://t.me/CR_T2)", disable_web_page_preview=True)
