...
async def cbguides(_, query: CallbackQuery):
 ...
 📌 إذا لم ينضم البوت إلى المكالمة ، فتأكد من تشغيل المكالمة  بالفعل ، أو اكتب *غادر* ثم اكتب *انضم* مرة أخرى

 💡 إذا كانت لديك أسئلة  حول هذا البوت ، فيمكنك إخبارنا من خلال جروب الدعم الخاصة بنا من هنا ↤ @{GROUP_SUPPORT}
...
⌯ /play او تشغيل +「اسم الأغنية / رابط」لتشغيل اغنيه في المحادثه الصوتيه
...
⌯ *اسكت* 「لإنهاء الموسيقى / الفيديو في الكول」
⌯ *تنزيل* + 「الاسم تنزيل صوت من youtube」
⌯ /vsong + 「الاسم  تنزيل فيديو من youtube」
⌯ *تخطي* 「للتخطي إلى التالي」
⌯ *بينج* 「إظهار حالة البوت بينغ」
⌯ *مدة التشغيل* 「لعرض مده التشغيل للبوت」
