...
async def join_chat(c: Client, m: Message):
    ...
    try:
        ...
        if invitelink.startswith("https://t.me/+"):
            ...
            return await user.send_message(chat_id, "سامو عليكو اعملولي شاي كدا الاول 😂✈️")
    except UserAlreadyParticipant:
        return await user.send_message(chat_id, "انا هنا اهو يا اعمى 😂✈️")
...
async def leave_chat(_, m: Message):
    ...
    try:
        ...
        return await _.send_message(
            chat_id,
            "المساعد طفش منكم لله 😂✈️",
        )
    except UserNotParticipant:
        return await _.send_message(
            chat_id,
            "دا ماشي من بدري انت لسه فاكر 🙃",
        )
